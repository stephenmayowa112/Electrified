            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg hover-lift">
                ...
                <div>
                  ...
                  <a href="tel:+2348082999567" className="text-sm text-gray-600 hover:text-cyan-600">
                    +234 (0) 808 299 9567
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg hover-lift">
                ...
                <div>
                  ...
                  <a href="mailto:info@electrifiedengineering.com" className="text-sm text-gray-600 hover:text-cyan-600 break-all">
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg hover-lift">
                <Globe className="w-6 h-6 text-cyan-600 mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg hover-lift">
                <Clock className="w-6 h-6 text-cyan-600 mt-1 flex-shrink-0" />
                <div>
            ...
            <div className="bg-gray-50 p-6 sm:p-8 rounded-xl shadow-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 text-sm sm:text-base border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-cyan-600 focus:border-transparent`}
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full p-3 text-sm sm:text-base border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-cyan-600 focus:border-transparent`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full p-3 text-sm sm:text-base border ${errors.phone ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-cyan-600 focus:border-transparent`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-3 text-sm sm:text-base border ${errors.title ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-cyan-600 focus:border-transparent`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="5"
                    className={`w-full p-3 text-sm sm:text-base border ${errors.message ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-cyan-600 focus:border-transparent resize-none`}
                ...
                <button
                  ...
                  className="w-full bg-cyan-600 text-white py-3 px-6 rounded-lg hover:bg-cyan-700 transition-all duration-300 font-medium text-sm sm:text-base flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
              ...
              {status.message && (
                <div className={`mt-6 p-4 rounded-lg flex items-start ${
                  status.type === 'success' ? 'bg-cyan-50 text-cyan-800' : 'bg-red-50 text-red-800'
                }`}>
                  {status.type === 'success' ? (
