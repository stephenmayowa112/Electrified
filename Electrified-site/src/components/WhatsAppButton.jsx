...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 left-8 z-50 p-4 bg-gradient-to-br from-teal-400 to-cyan-500 text-white rounded-full shadow-lg hover:from-teal-300 hover:to-cyan-400 transition-all duration-300 hover:scale-110 animate-fade-in group"
